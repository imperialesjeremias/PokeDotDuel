...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      card: {
        id: listing.cards.id,
        dexNumber: listing.cards.dex_number,
        name: listing.cards.name,
        isShiny: listing.cards.is_shiny,
        rarity: listing.cards.rarity,
        level: listing.cards.level,
        stats: listing.cards.stats,
        types: listing.cards.types,
      },
    });
  } catch (error) {
